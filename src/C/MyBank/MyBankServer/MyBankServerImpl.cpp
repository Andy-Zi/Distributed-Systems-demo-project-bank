...
void login(unsigned char* username, unsigned char* password, long* token, unsigned char** res)
{
    try {
...
void newaccount(long token,unsigned char* username,unsigned char* description, long* account_number, unsigned char** res)
{
    try {
...
void newuser(long token, unsigned char* username, unsigned char* password, unsigned char** res)
{
    try {
...
void listaccounts(long token, unsigned char** descriptions, unsigned char** res)
{
    try {
...
void payinto(long token,long account_number,float amount, unsigned char** res)
{
    try {
...
void transfer(long token, long from_account_number, long to_account_number, float amount, unsigned char* comment, unsigned char** res)
{
    try {
...
void statement(long token, long account_number, long detailed, unsigned char** statement_out, unsigned char** res)
{
    try {
...
void bye(long token, unsigned char** res)
{
    try {
        bank.logout(token);
        int strResLen = strlen("0") + 1;
