...
#define IMyBankATL_Transfer(This,token,fromAccountNumber,toAccountNumber,receiverName,amount,comment)	\
    ( (This)->lpVtbl -> Transfer(This,token,fromAccountNumber,toAccountNumber,receiverName,amount,comment) ) 
